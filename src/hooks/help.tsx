...
export const tourSteps: TourStep[] = [
  {
    ...
    content: 'Te guiaremos por las funciones principales de la aplicación para que puedas sacar el máximo provecho.',
    target: 'body',
    position: 'bottom'
  },
  {
    id: 'theme-toggle',
    title: 'Cambiar tema',
    content: 'Puedes alternar entre tema claro y oscuro para una mejor experiencia visual.',
  ...
  },
  {
    ...
    content: 'Navega entre APU y Presupuesto. También puedes usar Ctrl+1 y Ctrl+2 para cambiar rápidamente.',
    target: '[data-tour="tabs"]',
    position: 'bottom'
  },
  {
    id: 'apu-selector',
    title: 'Selector de APU',
    content: 'Aquí puedes elegir diferentes análisis de precios unitarios predefinidos.',
    target: '[data-tour="apu-selector"]',
    position: 'right'
  },
  {
    id: 'apu-details',
    title: 'Detalles del APU',
    content: 'Visualiza los recursos, cantidades y precios que componen cada APU.',
    target: '[data-tour="apu-details"]',
    position: 'top'
  },
  {
    id: 'budget-table',
    title: 'Tabla de presupuesto',
    content: 'Agrega partidas, ajusta metrados y calcula automáticamente totales con gastos generales, utilidad e IVA.',
  ...
  },
  {
    ...
    content: 'Presiona F1 para ver todos los atajos disponibles y trabajar más eficientemente.',
