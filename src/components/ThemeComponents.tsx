    ...
    <div className="bg-slate-100 dark:bg-slate-800 rounded-xl p-4 space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          <button className="px-3 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition-colors">
            Botón Primario
          </button>
          <button className="px-3 py-2 bg-slate-200 dark:bg-slate-700 text-slate-900 dark:text-slate-100 rounded-lg hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors">
            Botón Secundario
          </button>
          <input 
            type="text" 
